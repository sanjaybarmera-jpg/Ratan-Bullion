  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 items-start">
        ...
        {firms.length > 0 && (
          <section className="space-y-2 md:col-span-2 lg:col-span-1">
                ...
                >
                  ...
                  {f.phone && (
                    <a
                      ...
                      className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground shadow hover:brightness-110"
                    >
